                    ...
                    <section className='px-4 pt-4'>
                        <section className=" flex items-center gap-x-1">
                            <input
                                ...
                                className={`${formik.errors.mainCategoryName && formik.touched.mainCategoryName ?  "border-red-400 hover:border-red-600  focus:border-red-600" : "border-gray-300 hover:border-gray-600  focus:border-gray-600"} w-[300px]  focus:ring-0 text-sm  font-iranyekan-regular bg-white text-gray-800 rounded-md `}/>
                        </section>
                        {formik.errors.mainCategoryName && formik.touched.mainCategoryName && <p className={'text-red-600 font-iranyekan-regular text-xs pt-2'}>{formik.errors.mainCategoryName}</p>}
                    </section>
                    <DialogActions>
