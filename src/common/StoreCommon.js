...
const StoreCommon = ({store , index}) => {
    return (  
        <div  key={index}>
            <section className='  flex flex-col xl:flex-row justify-between mt-0 group py-4 px-3 md:px-8 hover:bg-gray-50 cursor-pointer'>
                <div className="ml-2">
                ...
                <div className='whitespace-nowrap flex w-fit gap-y-1 flex-row  items-center xl:items-start '>
                ...
                <section className="flex items-center gap-x-5">
                    <p className={`text-gray-700  font-bold whitespace-nowrap font-sans`}>
