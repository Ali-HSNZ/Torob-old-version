    ...
    return ( 
        <div className="bg-white   w-full sm:w-2/5 fixed z-50 right-0 bottom-0 top-0">
            ...
            <div className="px-4 mt-6 flex w-full">
                ...
                <h6 className="text-sm  text-center w-full font-sans">انتخاب دسته بندی</h6>
            </div>
                    ...
                    { !returnSubcategory(category) ?  categories.categories.map((category, index) => {
                        ...
                        <div className="flex flex-col ">
                            ...
                            <div className="bg-gray-100 flex right-0 gap-x-4 w-full h-auto absolute bottom-0 py-4 px-4">
                                <button onClick={()=> {delete query.category & router.push({pathname : "/search" , query : {...query}}) & closeHandler("")}}  className="w-full border border-gray-700 rounded-md text-sm font-sans  py-3">
                                      حذف فیلتر دسته‌بندی
                                </button>
                            </div>
