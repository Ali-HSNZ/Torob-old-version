        ...
        <form onSubmit={formik.handleSubmit} className="bg-[#ffffff] rounded-md p-4">
            ...
            <section className="mt-4 px-10">
                <div>
                    ...
                    <input dir="ltr" name="phoneNumber" onBlur={formik.handleBlur}  value={formik.values['phoneNumber']} onChange={formik.handleChange}  className={` w-full mt-3 font-sans  py-2 bg-gray-50 text-sm p-4  rounded-md border border-gray-300 outline-none`}/>
                </div>
                ...
                <div className={`mt-4 ${data ? "" : "hidden"}`}>
                    ...
                    <input dir="ltr" name="validationCode" onBlur={formik.handleBlur}  value={formik.values['validationCode']} onChange={formik.handleChange}  className={` w-full mt-3 font-sans  py-2 bg-gray-50 text-sm p-4  rounded-md border border-gray-300 outline-none`}/>
                </div>
