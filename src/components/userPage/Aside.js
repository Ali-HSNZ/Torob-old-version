           ...
           {isMobileScreen && (
            ...
            <div className="py-3">
                <Link href={'/user/analytics'}>
                    <a  className={` flex items-center pr-8 py-3   ${router.pathname === '/user/analytics' ? "bg-red-50 text-red-600 " : "hover:bg-gray-50 "}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill='none' viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
                        </svg>
                        <span className="font-sans mr-2 font-bold text-sm">تغییرات قیمت</span>
                    </a>
                </Link>
                <Link href={'/user/favorites'}>
                    <a className={` flex items-center pr-8 py-3 ${router.pathname === '/user/favorites' ? "bg-red-50 text-red-600 " : "hover:bg-gray-50 "}`}>
                        <svg xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ">
                ...
                <Link href={'/user/history'}>
                    <a className={` flex items-center pr-8 py-3 ${router.pathname === '/user/history' ? "bg-red-50 text-red-600 " : "hover:bg-gray-50 "}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span className="font-sans mr-2  font-bold text-sm">مشاهدات اخیر</span>
                    </a>
                </Link>
            </div>
            ...
            <section className="py-3">
                ...
                <div className=" cursor-pointer relative hover:bg-gray-50">
                    ...
                    {/* //? Button */}
                    <label htmlFor="tracking_checkBox" className="pr-8 py-3   flex items-center cursor-pointer">
                        <span className="font-sans text-sm text-gray-700">پیگیری سفارش</span>
                    </label>
                    <svg className="w-4 h-4 peer-checked:rotate-[-90deg] absolute top-[15px] right-[12px]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                    </svg>
                    {/* //? Content */}
                    <section className="hidden flex-col peer-checked:flex">
                        <Link href={"#"}>
                            <a className="text-xs text-gray-700 font-sans pr-9  py-3 hover:bg-gray-200">لیست فروشگاه‌های ترب</a>
                        </Link>
                        <Link href={"#"}>
                            <a className="text-xs text-gray-700 font-sans pr-9  py-3 hover:bg-gray-200">ثبت نام فروشگاه</a>
                        </Link>
                    </section>
                </div>
                ...
                <div className=" cursor-pointer relative hover:bg-gray-50">
                    ...
                    {/* //? Button */}
                    <label htmlFor="guidance_checkBox" className="pr-8 py-3   flex items-center cursor-pointer">
                    ...
                    <section className="hidden flex-col peer-checked:flex">
                        <Link href={"#"}>
                            <a className="text-gray-700 font-sans pr-9 text-xs py-3 hover:bg-gray-200">راهنمای خرید امن</a>
                        </Link>
                        <Link href={"#"}>
                            <a className="text-gray-700 font-sans pr-9 text-xs py-3 hover:bg-gray-200">قوانین و مقررات</a>
                        </Link>
                        <Link href={"#"}>
                            <a className="text-gray-700 font-sans pr-9 text-xs py-3 hover:bg-gray-200">حریم خصوصی</a>
                        </Link>
                    </section>
                </div>
