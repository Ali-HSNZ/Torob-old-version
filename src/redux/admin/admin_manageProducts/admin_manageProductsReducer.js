...
export const admin_productsReducer = (state = initailState , action) => {
     switch (action.type) {
          ...
          case ADMIN_INSERT_ONE_PRODUCT_FAILURE:{ return { ...state, product : { product : state.product.product , loading : false , error : action.payload } }}

          // Insert Fetch One Product State =>
          ...
          case ADMIN_FETCH_ONE_PRODUCT_FAILURE:{ return { ...state, product : { product : state.product.product , loading : false , error : action.payload } }}

          // Insert Fetch Brands State =>
          case ADMIN_FETCH_BRANDS_REQUEST : {return {...state , brands : { brands : null, loading : true,error : null}}}
          case ADMIN_FETCH_BRANDS_SUCCESS : {return {...state,brands : {brands : action.payload.brands, loading : false,error : null}}}
          case ADMIN_FETCH_BRANDS_FAILURE : {return {...state,brands : {brands : null, loading : false,error : action.payload}}}

          // Insert Fetch Categories State =>
          ...
          // Insert Fetch Categories Sub 1 State =>
          ...
          // Insert Fetch Categories Sub 2 State =>
          ...
          // Insert Fetch Categories Sub 3 State =>
