...
export const buttonClassName = ({ bgColor , isValid , isOutline}) => {
     if(isOutline){
          return `shadow-${bgColor}-300 shadow-sm md:shadow-md  lg:shadow-lg ${isValid ? ` hover:bg-${bgColor}-200 bg-${bgColor}-100 border border-${bgColor}-600 text-${bgColor}-800 cursor-pointer` : "ring-gray-400 cursor-not-allowed hover:bg-gray-800 bg-gray-700 border border-gray-600 text-gray-100"}  py-2 px-6 font-sans  text-sm rounded-md`
     }else{
          return ` shadow-${bgColor}-400  shadow-sm md:shadow-md  lg:shadow-lg ${isValid ? `ring-${bgColor}-400 hover:bg-${bgColor}-700 bg-${bgColor}-600 border   text-white cursor-pointer ` : "ring-gray-400 cursor-not-allowed hover:bg-gray-800 bg-gray-700 border border-gray-600 text-gray-100"}  py-2 px-6 font-sans  text-sm rounded-md`
     }
}
