                                    ...
                                    <Form>
                                        ...
                                        <div className="mt-6 w-full flex justify-end gap-x-2">
                                            <section className=" flex justify-end  items-center ">
                                                ...
                                                <button disabled={loading} type={"submit"} className={`flex items-center hover:bg-blue-200 bg-blue-100 border border-blue-600 text-blue-800 cursor-pointer   py-[6px] px-6 font-sans  text-sm rounded-md`}>
                                                    ثبت کالا
                                                </button>
                                            </section>
                                        </div>
