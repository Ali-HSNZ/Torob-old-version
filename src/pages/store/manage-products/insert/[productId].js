     ...
     const calculateTotalPrice = ({price , count , type}) => {
          if(type == "count"){
               if(ONLY_DIGIT_REGIX.test(price && price.replace(/,/g, '')) && ONLY_DIGIT_REGIX.test(count && count.replace(/,/g, ''))){
                    ...
                    return <p className="font-sans text-gray-800 text-xs whitespace-nowrap pt-2 font-bold">قیمت {toPersianPrice(count)} کالا : {toPersianPrice(total)} تومان</p>
               }
          }
          return ``
     }
                                             ...
                                             <FieldArray 
                                                  ...
                                                  render={arrayHelpers  => (
                                                       <div className="flex flex-col mt-4">
                                                            <div className="font-sans text-sm text-gray-800 before:content-['*'] before:text-red-600">
                                                                 تخفیف پله‌ایی :
                                                                      ...
                                                                      <section key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  mt-4 gap-4 bg-[#FCFCFC] border border-gray-200 p-4 rounded-lg">
                                                                           ...
                                                                           <div className="flex items-start flex-col">
                                                                                ...
                                                                                <Field 
                                                                                     ...
                                                                                     className="mt-2 placeholder:text-sm w-full border-gray-300 hover:border-gray-600  focus:border-gray-600 focus:ring-0 text-sm  font-sans bg-white text-gray-800 rounded-md "
                                                                                />
                                                                                {calculateTotalPrice({
                                                                           ...
                                                                           <div className="flex flex-col items-start" >
                                                                                ...
                                                                                <div className="flex flex-row w-full mt-2">
                                                                                     <Field 
                                                                                          ...
                                                                                          className="w-full placeholder:text-sm border-gray-300 hover:border-gray-600  focus:border-gray-600 focus:ring-0 text-sm  font-sans bg-white text-gray-800 rounded-md "
                                                                                     />
                                                                                     <div className="flex items-center">
