...
const InsertStoreProduct = () => {
    ...
    const onSubmit = (values) => {
        dispatch(insertStoreProduct({product_id:query.productId, values,production_date : production_date.toDate().toLocaleDateString('fa-IR') ,expire_date : expire_date.toDate().toLocaleDateString('fa-IR')}))
    }
