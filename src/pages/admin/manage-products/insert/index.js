...
import { admin_fetchCategoriesFailure, admin_fetchCategoriesSuccess, fetchBrandsFailure, fetchBrandsSuccess, fetchSub1, fetchSub2, fetchSub3, insertProduct } from "@/redux/admin/admin_manageProducts/admin_manageProductsActions";
               ...
               <div className="w-full flex flex-col lg:flex-row  justify-between ">
                    ...
                    <section  className=" w-full lg:w-4/5 flex-0 h-max p-4">
                         ...
                         <section className=" bg-white outline-none sm:w-1/2 h-1/2 rounded-md  flex flex-col justify-center items-center p-4 relative">
                              <img alt="تصویر کالا" className="max-h-full w-auto" src={imageSrc_modal && imageSrc_modal.imageUrl || ""}/>
                              ...
                              <div className="w-full flex justify-end gap-x-3 absolute bottom-2 left-0 py-1 px-3  bg-[#fffffff0]">
                                   <button onClick={() => deleteImageViaId(imageSrc_modal.id)} className="text-xs font-iranyekan-regular rounded-md hover:underline underline-offset-4 text-red-600">حذف تصویر</button>
                         ...
                         <div className="p-5 mt-4 bg-white rounded-lg border border-gray-100 shadow-md dark:bg-gray-800 dark:border-gray-700">
                              ...
                              <section  className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                                   ...
                                   <div className="flex flex-col relative">
                                        <p className="font-iranyekan-regular text-sm text-gray-800 before:content-['*'] before:text-red-600">برند :</p>
                              ...
                              <div className="w-full mt-4 flex flex-col  gap-x-4">
                                   <section className="flex items-center">
                                        <p className="font-iranyekan-regular text-sm text-gray-800 before:content-['*'] before:text-red-600">دسته‌بندی :</p>
                                        ...
                                        <div className="class_grid_manage_products sm:mr-4 ">
                                             ...
                                             return(
                                                  <div key={image.id} onClick={()=>{setImageSrc_modal(image) , setIsImage_modal(true)}} className="z-10 cursor-pointer group h-28 p-1 relative border-gray-500 border w-auto flex   rounded-md overflow-hidden items-center justify-center">
                                                       <img alt="تصویر کالا" src={image.imageUrl} className="h-full w-auto"/> 
                         ...
                         <div className="mt-6 w-full flex justify-end gap-x-2">
                              ...
                              <section className=" flex justify-end  items-center ">
                                   <button disabled={productLoading} type={"submit"} className={buttonClassName({bgColor : "blue" , isValid : !productLoading , isOutline : false})}>
                                        ثبت کالا
                                   </button>
                              </section>
                         </div>
