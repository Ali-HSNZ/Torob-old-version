                ...
                <section className="w-full lg:w-4/5 flex-0 h-max px-4 "> 
                    ...
                    <div className="flex justify-between w-full items-center mt-4">
                        <div className="flex items-center">
                            ...
                            <h1 className="font-iranyekan-regular font-iranyekan-bold text-lg text-gray-800">اطلاعیه ها</h1>
                        </div>
                    ...
                    {data?.notifications?.length > 0 && (
                        <>
                            <section className="sticky top-0 z-20 rounded-md mt-4 bg-white p-4 overflow-hidden  w-full shadow-md flex flex-row justify-end gap-x-4">
                                ...
                                {isSelectedAll() ? (
                                    <button onClick={() => setSelectedId([])} className={`text-yellow-800 font-iranyekan-regular text-sm border border-yellow-600 px-6 py-2 rounded-md bg-yellow-100 hover:bg-yellow-200`} >لغو انتخاب شده‌ها</button>
                                ) : (
