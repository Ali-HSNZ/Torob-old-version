...
const InsertStore = () => {
    ...
    const onSubmit = (values) => {
        ...
        dispatch(insertStore({values,logo,license,storeBanner,city,province,bankCardNumber}))
    }
    
    const PHONE_NUMBER_REGIX = /^09[0|1|2|3][0-9]{8}$/;
    const STATIC_PHONE_NUMBER_REGIX = /^0[0-9]{2,}[0-9]{7,}$/;
    ...
    return (  
        <Layout isFooter={true} pageTitle={"پنل مدیریت | افزودن فروشگاه"}>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <section  className="grid grid-cols-3 gap-4 mt-6">
                            ...
                            <div className="flex flex-col relative ">
                                ...
                                <input type={'file'} id="chooseImage_license" ref={image_license_Input_ref} accept=".jpg,.png,.jpeg,.webp" className="hidden" onChange={event => changeFIleAction_input(event,64,2048,setOnChangeFile_license,"مجوز","64 کیلوبایت","2 مگابایت",image_license_Input_ref)}/>
                        ...
                        <section className="w-full flex justify-end mt-3 items-center ">
                            <button disabled={loading || !formik.isValid} type={"submit"} className={`flex items-center ${formik.isValid ? " hover:bg-blue-200 bg-blue-100 border border-blue-600 text-blue-800 cursor-pointer " : "cursor-not-allowed hover:bg-gray-800 bg-gray-700 border border-gray-600 text-gray-100"}  py-[6px] px-6 font-sans  text-sm rounded-md`}>
