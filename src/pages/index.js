        ...
        <>
            ...
            <section className='absolute top-0 bottom-0  w-full flex justify-center flex-col items-center '>
                ...
                <main className='mt-8 w-full flex justify-center relative '>
                    <form method='get' className='w-full flex  justify-center' onSubmit={form => onSubmitForm(form)}>
                        ...
                        <div className="relative w-full lg:w-fit h-auto">
                                   <input autoComplete={"off"} value={inputValue} onChange={input => searchInputHandler(input.target.value)} id="searchInput" className="pr-12 bg-white border border-gray-300 outline-none rounded-md placeholder:text-sm text-sm text-gray-700 py-3 w-full font-sans lg:w-[420px] shadow-sm px-4"  placeholder="جستجو" />
