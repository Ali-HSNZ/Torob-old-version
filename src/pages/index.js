  ...
  return (
    <section className='absolute top-0 bottom-0  w-full flex justify-center flex-col items-center '>
        ...
        <section className='mt-8 w-full flex justify-center relative '>
          ...
          <input className='w-9/12 sm:w-[470px] font-sans  h-12 focus:ring-0 text-base pr-12 focus:outline-none focus:border-gray-300 rounded-md border-gray-300 outline-none' type="text" placeholder='نام کالا را وارد کنید'/>
