        ...
        <section className="w-full sm:w-fit flex justify-end relative z-20">
          {user && user.account_type === 'normal' ? (
            ...
            <>
              ...
              <div className={`bg-white rounded-b-md ${userPanel ? "" : "hidden"} absolute  top-[37px] left-[1px]  whitespace-nowrap py-2`}>
            ...
            <>
              {!loading ? (
                <button onClick={() => closeCategory() & dispatch(authPanel({isOpen : true,type : "normal"}))} className="whitespace-nowrap rounded-md border  text-gray-800  border-gray-300 bg-white px-4 md:py-3 py-2 font-sans text-sm">
                  ورود / ثبت نام
                </button>
              ) : (
