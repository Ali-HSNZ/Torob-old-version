     ...
     return (
          <header className="flex relative  justify-between p-4 bg-gray-50 items-center z-10">
               ...
               <section className="w-full sm:w-fit flex justify-end  ">
                    {/* Cart */}
                    <Link href={'/cart'}>
                         <a className="relative flex items-center justify-center ml-4 bg-white px-4 py-2 border border-gray-300 rounded-md text-sm font-iranyekan-regular text-gray-700"> 
                    ...
                    <section className="relative w-[123px]">
                        ...
                        {user?.phone_number_primary && <button onClick={() => handleUserPanel_btn()} className="w-full userPhoneNumber_btn bg-white  py-2 border border-gray-300 rounded-md text-sm font-iranyekan-regular text-gray-700 " >
