       ...
       <>
            <section className="w-full h-auto bg-gray-50 flex justify-between flex-col lg:flex-row">
                <section className="w-full lg:w-1/2 flex lg:gap-0 gap-x-16 lg:justify-between p-5 md:p-10">
                    <div className="flex flex-col gap-y-2">
                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">پنل فروشگاه‌ها</a>
                        </Link>
                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">ثبت فروشگاه</a>
                        </Link>
                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">فروشگاه‌ها</a>
                        </Link>
                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">پیگیری سفارش از فروشگاه</a>
                        </Link>
                    </div>
                    <div className="flex flex-col gap-y-2">
                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">قوانین و مقررات</a>
                        </Link>

                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">درباره ترب</a>
                        </Link>

                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">تماس با ما</a>
                        </Link>

                        <Link href={"#"}>
                            <a className="hover:text-red-600 font-sans text-xs sm:text-sm text-gray-600 py-1">پیشنهادات و گزارش خطا</a>
                        </Link>
                    </div>
                </section>
            ...
            <section className="bg-gray-50 w-full flex flex-col lg:flex-row justify-between p-5 md:p-10 items-center">
                <div className="w-full lg:w-1/2 flex items-center justify-between lg:justify-start">
                    <h5 className="text-gray-600 font-sans text-xs sm:text-base">ترب، موتور جستجوی هوشمند خرید</h5>
